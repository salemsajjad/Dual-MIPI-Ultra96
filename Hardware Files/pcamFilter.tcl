...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:hls:AcceleratedFilter:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: AcceleratedFilter_0, and set properties
  set AcceleratedFilter_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:AcceleratedFilter:1.0 AcceleratedFilter_0 ]
  ...
  connect_bd_intf_net -intf_net AcceleratedFilter_0_axis_out [get_bd_intf_pins AcceleratedFilter_0/axis_out] [get_bd_intf_pins pixel_pack_0/stream_in_24]
  ...
  connect_bd_intf_net -intf_net axis_subset_converter_1_M_AXIS [get_bd_intf_pins AcceleratedFilter_0/axis_in] [get_bd_intf_pins axis_subset_converter_1/M_AXIS]
  ...
  connect_bd_net -net M07_ARESETN_1 [get_bd_pins AcceleratedFilter_0/ap_rst_n] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axi_interconnect_0/M06_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins axis_subset_converter_2/aresetn] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aresetn] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aresetn] [get_bd_pins pixel_pack_0/ap_rst_n] [get_bd_pins pixel_pack_0/ap_rst_n_control] [get_bd_pins pixel_unpack_0/ap_rst_n] [get_bd_pins pixel_unpack_0/ap_rst_n_control] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_demosaic_0/ap_rst_n] [get_bd_pins v_tc_0/s_axi_aresetn]
  ...
  connect_bd_net -net clk_wiz_1_clk_out2 [get_bd_pins AcceleratedFilter_0/ap_clk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins axis_subset_converter_1/aclk] [get_bd_pins axis_subset_converter_2/aclk] [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aclk] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aclk] [get_bd_pins pixel_pack_0/ap_clk] [get_bd_pins pixel_pack_0/control] [get_bd_pins pixel_unpack_0/ap_clk] [get_bd_pins pixel_unpack_0/control] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_demosaic_0/ap_clk] [get_bd_pins v_tc_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
